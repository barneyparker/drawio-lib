...
export const link = (id, dashed=false, source, target) => `
        <mxCell id="${id}" style="orthogonalLoop=1;html=1;dashed=${dashed ? '1' : '0'};" edge="1" parent="1" source="${source}" target="${target}">
